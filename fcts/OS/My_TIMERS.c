...
//Configuration TIMER1 en overflow toutes les 1 ms
void TIMER1_1ms(void)
{
	T1CONbits.T1RD16 = 1;		//Opérations sur 16bits
	T1CONbits.TMR1CS = 0b00;	//Fréquence TIMER1 = 4 x période d'horlode
...
//Configuration TIMER1 en overflow toutes les 10 ms
...
//Configuration TIMER1 en overflow toutes les 100 ms
