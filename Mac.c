...
#define NIC_ADDR_IO         (PORTA)	//mx changed from PARTB to PORTA
#define NIC_DATA_IO         (PORTD)

#define NIC_DATAPORT        (0x20)  //mx changed from 0x10 to 0x20
#define NIC_RESET           (0x2f)  //mx changed from 0x1f to 0x2f
